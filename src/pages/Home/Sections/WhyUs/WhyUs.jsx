...
const DATA = [
  {
    ...
    content: "Every partner at GoBongo has built, scaled, or exited a company. We don't just write cheques — we embed ourselves in the work. We've felt the friction. We know what it takes.",
  },
  {
    id: "02",
    title: "DUBAI ADVANTAGE",
    subtitle: "THE GLOBAL BRIDGE",
    content: "Headquartered in the world's most business-friendly city. 0% corporate tax, 200+ nationalities, DIFC access, and a geographic position as the literal bridge between East and West markets.",
  },
  {
    id: "03",
    title: "COMPOUNDING",
    subtitle: "CROSS-PORTFOLIO SYNERGY",
    content: "When Tezz Logistics needs digital services, Hooqx delivers. When GoBongo Shop needs logistics, Tezz routes it. Our portfolio creates synergies no single investment can manufacture alone.",
  },
  {
    id: "04",
    title: "LONG-HORIZON",
    subtitle: "DECIMAL THINKING",
    content: "We measure success in decades, not quarters. We partner with founders who share this conviction — because the most valuable companies are built slowly, deliberately, and with the long game always in mind.",
  },
];
              ...
              >
                ...
                >
                  ...
                  <div className="elite-trigger-right">
                    ...
                    <div className={`elite-icon-wrap ${isActive ? "active" : ""}`}>
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                        <path d="M12 5v14M5 12h14" className={`plus-vertical ${isActive ? "hidden" : ""}`} />
                        <path d="M5 12h14" />
                      </svg>
                    </div>
                  </div>
