...
const SECTORS = [
  {
    ...
    tagColor: "#1A56E8",
    tagBg: "#EEF3FF",
    desc: "Retail in the UAE and MENA is being rebuilt from the ground up  online platforms, omnichannel supermarkets, and discovery-led commerce models are all converging. We invest in the brands and infrastructure that will define how the next generation of consumers shops, in-store and online.",
    thesis: "Commerce isn't just moving online  it's being rebuilt for a world where the best retailers operate everywhere at once.",
    count: "4 Ventures",
    ventures: ["Thescooda", "GoBongo Shop", "BigBuy", "BigMeat"],
    accent: "#1A56E8",
  },
  {
    id: "logistics",
  ...
  },
  {
    ...
    tagColor: "#7C3AED",
    tagBg: "#F3F0FF",
    desc: "Every business in every sector needs a digital layer. From digital agencies and communication platforms to HealthTech marketplaces that connect doctors with practice space, IT and digital services are the picks-and-shovels plays that win regardless of which vertical leads the next wave.",
    thesis: "The digitisation of business is not a trend  it's a transformation that's decades from complete.",
    count: "2 Ventures",
    ventures: ["Hooqx LLC", "WeDocX"],
    accent: "#7C3AED",
  },
  {
    id: "trade",
