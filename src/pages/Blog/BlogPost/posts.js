...
export const POST_CONTENT = {
  'tezz-logistics-investment': {
    ...
    body: [
      ...
      {
        type: 'p',
        text: 'We led Tezz\'s pre-seed round at a time when most institutional capital was chasing SaaS multiples. Our thesis was simple: the infrastructure layer for tier-2 e-commerce in India would be worth tens of billions by 2030, and whoever owned the last-mile trust relationship with consumers in these cities would win.',
      },
      {
        type: 'p',
